package com.wxl.export.lifter.common.widget.cycleviewpager;
...
public class CycleViewPager extends Fragment implements OnPageChangeListener {
    ...
    public void initView() {
        ...
        indicatorLayout = (LinearLayout) rootView
                .findViewById(R.id.layout_viewpager_indicator);

        viewPagerFragmentLayout = (FrameLayout) rootView
                .findViewById(R.id.layout_viewager_content);

        handler = new CycleViewPagerHandler(activity) {
    ...
    private void setIndicator(int selectedPosition) {
        for (int i = 0; i < indicators.length; i++) {
            indicators[i]
                    .setBackgroundResource(R.drawable.common_icon_indactor_unchecked);
        }
        if (indicators.length > selectedPosition)
            indicators[selectedPosition]
                    .setBackgroundResource(R.drawable.common_icon_indactor_inchecked);
    }
