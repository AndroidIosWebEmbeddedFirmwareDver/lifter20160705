...
/**
 * 
 * @Desc: 仿58同城页面加载动画View <VERSION.SDK_INT >= VERSION_CODES.HONEYCOMB可以使用>
...
public class LoadingView extends RelativeLayout
{
	...
	{ 0f, -dip2px(TOP_HEIGHT), 0f };
	private final float[] SCALEX =
	{ 0.9f, 0.5f, 0.2f, 0.1f, 0.05f, 0.1f, 0.2f, 0.3f, 0.5f, 0.7f, 0.9f };
	...
	private void initView()
	{
		...
		mCircleView.setBackgroundResource(R.drawable.loading_squre);
		...
		mRectView.setBackgroundResource(R.drawable.loading_sixsqure);
		...
		mTriangleView.setBackgroundResource(R.drawable.loading_fivestar);
