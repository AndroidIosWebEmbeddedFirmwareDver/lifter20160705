package com.wxl.export.lifter.common.widget.rfview;
...
public class AnimRFRecyclerView extends RecyclerView implements Runnable {
    ...
    public void setHeaderImage(ImageView headerImage) {
        ...
        if (headerImageHeight <= 0) {
            ...
            AnimRFRecyclerView.this.headerImage.getLayoutParams().height = headerImageHeight;
        }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 1:
                    ...
                    headerImage.setAlpha(1 - (float) msg.arg1
     ...
     * 自定义恢复时的动画
     */
    private class ResetAnimaton extends Animation {
        ...
        protected void applyTransformation(float interpolatedTime, Transformation t) {
            ...
            float offset = headerImageScaleHeight * interpolatedTime;
            if (headerImage.getLayoutParams().height - headerImageHeight > 0) {
                // 新高度
                headerImage.getLayoutParams().height -= offset;
                // 计算新拉伸高度
                headerImageScaleHeight -= offset;
                // 透明度
                updateHeaderAlpha();
                // 重新布局
                headerImage.requestLayout();
                // 重写布局，防止分割线残留
                layout(getLeft(), getTop(), getRight(), (int) (getBottom() - offset));
            }
        }
    }
