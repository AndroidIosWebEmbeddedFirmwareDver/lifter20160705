...
public class SelectableRoundedImageView extends ImageView
{
	...
	public SelectableRoundedImageView(Context context, AttributeSet attrs, int defStyle)
	{
		...
		mRadii = new float[]
		{ mLeftTopCornerRadius, mLeftTopCornerRadius, mRightTopCornerRadius, mRightTopCornerRadius, mRightBottomCornerRadius, mRightBottomCornerRadius, mLeftBottomCornerRadius,
	...
	static class SelectableRoundedCornerDrawable extends Drawable
	{
		...
		private float[] mRadii = new float[]
		{ 0, 0, 0, 0, 0, 0, 0, 0 };
		private float[] mBorderRadii = new float[]
		{ 0, 0, 0, 0, 0, 0, 0, 0 };
